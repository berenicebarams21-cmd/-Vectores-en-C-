...
int main() {
    ...
    cout << "\nIngrese el indice del producto a modificar (0 a "
         << inventario.size() - 1 << "): ";
    cin >> indice;
    ...
    cout << "\nDespues de modificar el precio del producto en indice "
         << indice << endl;
    ...
    cout << "\nProducto en la posicion " << posicion << " - "
